...
public class MailUtil {
	...
	public static void sendEmailRegistrationLink(String id, String email) throws AddressException, MessagingException, UnsupportedEncodingException {
		...
		String link = Setup.MAIL_REGISTRATION_SITE_LINK+"?scope=activation&userId="+id+"&hash=";
